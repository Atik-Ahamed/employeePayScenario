...
@section('content')
    <div class="container">
        ...
        <header class="jumbotron my-4" >
            <h1 class="display-3 text-center">Employee Pay Scenario</h1>
        ...
        <div class="row text-center">
            ...
            <div class="col-lg-3 col-md-6 mb-4 ">
                <div class="card">
                    <div class="card-body">
                        <h2 class="btn btn-warning card-title font-italic">QUERY ONE</h2>
            ...
            <div class="col-lg-3 col-md-6 mb-4 ">
                <div class="card">
                    <div class="card-body">
                        <h2 class="btn btn-warning card-title font-italic">QUERY TWO</h2>
            ...
            <div class="col-lg-3 col-md-6 mb-4 ">
                <div class="card">
                    <div class="card-body">
                        <h2 class="btn btn-warning card-title font-italic">QUERY THREE</h2>
            ...
            <div class="col-lg-3 col-md-6 mb-4 ">
                <div class="card">
                    <div class="card-body">
                        <h2 class="btn btn-warning card-title font-italic">QUERY FOUR</h2>
            ...
            <div class="col-lg-3 col-md-6 mb-4 ">
                <div class="card text-center">
                    <div class="card-body">
                        <h2 class="btn btn-warning card-title font-italic">QUERY FIVE</h2>
